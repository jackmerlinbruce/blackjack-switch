...
const pickupCards = ['h_2', 'd_2', 'c_2', 's_2', 'c_11', 's_11', 'h_11', 'd_11']
const pickupAmounts = {
    h_2: 2,
    d_2: 2,
    c_2: 2,
...
const getDeck = (shuffle = true, withJokers = false) => {
    const deck = []
...
const getAllowedCards = (lastPlayedCard, isPickupInPlay, isRunInPlay) => {
    const allowedCards = []
